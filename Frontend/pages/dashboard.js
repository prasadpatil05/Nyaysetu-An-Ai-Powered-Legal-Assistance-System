...
export default function Home() {
    ...
    return (
        <DashBoardWrapper page="dashboard">
            ...
            <Flex padding="4" mb="4" bgGradient='linear(to-r, blue.100, teal.100, green.100)' border='1px' borderColor='gray.100' rounded="lg" justifyContent={"space-between"} alignItems={"center"}>
                <Text fontSize={"xl"} fontWeight="bold">
                    <Highlight query='Legal Experts' styles={{ px: '2', py: '1', rounded: 'full', bg: 'white' }}>
                        Connect with Legal Experts for personalized advice
                    </Highlight>
                </Text>
                <Link href="/connect-lawyers">
                    <Button colorScheme="teal" size="md" fontWeight="bold">
                        Connect Now
                    </Button>
                </Link>
            </Flex>
