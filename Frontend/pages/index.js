...
export default function Home() {
        ...
        <Flex px={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'} >
              Empowering You with Legal Wisdom: NyaySetu -
              Unlock the doors to legal enlightenment with NyaySetu. Navigate the intricate web of laws effortlessly and empower yourself with legal wisdom at your fingertips. From understanding your rights to decoding legal jargon, NyaySetu is your go-to source for clarity in the complex world of law.
            </Text>
  ...
  // return <Flex
  // Empowering You with Legal Wisdom: NyaySetu - Your Trusted Digital Legal Companion.
  ...
  //   </Heading>
  //   <Text mt={6}>
  //     Empowering You with Legal Wisdom: NyaySetu - Your Trusted Digital Legal
  //     Companion.
  //   </Text>
  //   <Link href="/login">
  //     <Button
